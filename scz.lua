--[[
    CriminalHub v2.1 - Lua UI Library
    Estilo: WindUI / Rayfield
    Uso:
        local Hub = loadstring(game:HttpGet("..."))()
        local Window = Hub:CreateWindow({ Title = "Meu Hub", Key = "INSERT" })
...
-- ─────────────────────────────────────────────
-- Tema (cores do Criminal Hub)
-- ─────────────────────────────────────────────
local Theme = {
    Background   = Color3.fromRGB(9,  1,  1),
    Surface      = Color3.fromRGB(13, 1,  1),
    Sidebar      = Color3.fromRGB(6,  0,  0),
    Border       = Color3.fromRGB(70, 8,  8),
    Accent       = Color3.fromRGB(180,20, 20),
    AccentDim    = Color3.fromRGB(100,10, 10),
    TextPrimary  = Color3.fromRGB(220,220,220),
    TextSecondary= Color3.fromRGB(100,100,100),
    TextAccent   = Color3.fromRGB(200,40, 40),
    ToggleOn     = Color3.fromRGB(160,15, 15),
    ToggleOff    = Color3.fromRGB(30, 30, 30),
    SliderFill   = Color3.fromRGB(180,20, 20),
    InputBg      = Color3.fromRGB(8,  0,  0),
}
...
function CriminalHub:CreateWindow(cfg)
    ...
    local subtitle = cfg.Subtitle or "v2.1"
    ...
    -- Sombra
    local Shadow = NewGui("ImageLabel", {
        Name              = "Shadow",
        AnchorPoint       = Vector2.new(0.5,0.5),
        Size              = UDim2.new(1,30,1,30),
        Position          = UDim2.new(0.5,0,0.5,0),
        BackgroundTransparency = 1,
        Image             = "rbxassetid://6014054059", -- drop shadow
    ...
    NewGui("UICorner",    { CornerRadius = UDim.new(0,6), Parent = LogoBadge })
    NewGui("UIGradient",  { Color = ColorSequence.new{
        ColorSequenceKeypoint.new(0, Color3.fromRGB(190,16,16)),
        ColorSequenceKeypoint.new(1, Color3.fromRGB(90,0,0)),
    }, Rotation = 135, Parent = LogoBadge })
    NewGui("TextLabel", {
    ...
    -- Título
    local TitleLabel = NewGui("TextLabel", {
    ...
    local VerBadge = NewGui("TextLabel", {
        ...
        TextSize        = 9,
        Font            = Enum.Font.GothamBold,
        Parent          = TitleLabel, -- repositioned below
    })
    -- versão colocada após o label de título
    VerBadge.Parent = TitleBar
    VerBadge.Position = UDim2.new(0,46+130,0.5,-8)
    NewGui("UICorner", { CornerRadius = UDim.new(0,4), Parent = VerBadge })

    -- Botões de janela (minimize / close)
    ...
    NewGui("UIStroke", { Color = Color3.fromRGB(50,50,50), Thickness = 1, Parent = BtnMin })
    ...
    NewGui("Frame", {   -- borda superior do footer
        Size            = UDim2.new(1,0,0,1),
        BackgroundColor3= Theme.Border,
    ...
    NewGui("TextLabel", {
        Size            = UDim2.new(1,0,1,0),
        BackgroundTransparency = 1,
        Text            = "INSERT PARA ABRIR  •  END PARA FECHAR TUDO",
        TextColor3      = Color3.fromRGB(42,42,42),
        TextSize        = 9,
        Font            = Enum.Font.GothamBold,
        Parent          = Footer,
    })
    ...
    BtnMin.MouseButton1Click:Connect(function()
        ...
        local targetSize = WindowObj._minimized
            ...
            or  winSize
        Tween(MainFrame, TweenInfo.new(0.2, Enum.EasingStyle.Quart), { Size = targetSize })
    ...
    BtnClose.MouseButton1Click:Connect(function()
        ...
        Tween(MainFrame, TweenInfo.new(0.15, Enum.EasingStyle.Quart), {
            BackgroundTransparency = 1,
    ...
    UserInputSvc.InputBegan:Connect(function(input, gpe)
        ...
        if keyName:lower() == toggleKey:lower() then
    ...
    function WindowObj:CreateTab(cfg)
        ...
        -- Barra lateral esquerda (indicador ativo)
        ...
        local function ActivateTab()
            ...
            for _, t in pairs(self._tabs) do
                ...
                Tween(t._btn, TweenInfo.new(0.12), {
                    BackgroundTransparency = 1,
                })
                Tween(t._label, TweenInfo.new(0.12), { TextColor3 = Theme.TextSecondary })
                Tween(t._icon,  TweenInfo.new(0.12), { TextColor3 = Theme.TextSecondary })
            end
            -- Ativar este
            TabPage.Visible = true
            ActiveBar.Visible = true
            Tween(TabBtn, TweenInfo.new(0.12), {
                BackgroundTransparency = 0.75,
            })
            TabBtn.BackgroundColor3 = Theme.ToggleOn
            Tween(TabLabel, TweenInfo.new(0.12), { TextColor3 = Color3.fromRGB(255,85,85) })
            Tween(TabIcon,  TweenInfo.new(0.12), { TextColor3 = Color3.fromRGB(255,85,85) })
        ...
        -- Primeiro tab é ativado automaticamente
        ...
        function TabObj:CreateSection(name)
            ...
            function SectionObj:CreateToggle(cfg)
                ...
                local Row = NewGui("TextButton", {
                    ...
                    BackgroundColor3= on and Theme.ToggleOn or Color3.fromRGB(18,18,18),
                    BackgroundTransparency = on and 0.88 or 0.98,
                    BorderSizePixel = 0,
                    Text            = "",
                ...
                NewGui("UIStroke", {
                    Color     = on and Theme.Border or Color3.fromRGB(255,255,255),
                    Transparency = on and 0.7 or 0.95,
                    Thickness = 1,
                    Parent    = Row,
                })
                ...
                NewGui("UIStroke",  {
                    Color     = on and Theme.Accent or Color3.fromRGB(42,42,42),
                    Thickness = 1,
                    Parent    = Track,
                })
                ...
                local Knob = NewGui("Frame", {
                    ...
                    Position        = UDim2.new(0, on and 16 or 2, 0.5,-5.5),
                    BackgroundColor3= on and Color3.fromRGB(255,85,85) or Color3.fromRGB(68,68,68),
                    BorderSizePixel = 0,
                    Parent          = Track,
                })
            ...
            function SectionObj:CreateSlider(cfg)
                ...
                NewGui("UIStroke", { Color = Color3.fromRGB(255,255,255), Transparency = 0.96, Thickness = 1, Parent = Wrap })
                NewGui("UIPadding", {
                ...
                NewGui("UICorner", { CornerRadius = UDim.new(0,2), Parent = TrackBg })
                ...
                NewGui("UICorner", { CornerRadius = UDim.new(0,2), Parent = Fill })
                ...
                NewGui("UICorner", { CornerRadius = UDim.new(0,5), Parent = SliderKnob })
                ...
                UserInputSvc.InputChanged:Connect(function(input)
                    if dragging and (
                        ...
                        SliderKnob.Position = UDim2.new(newPct,-5,0.5,-5)
                        pcall(callback, val)
                    end
                end)
                ...
                local SliderObj = {
                    Set = function(self, v)
                        ...
                        SliderKnob.Position = UDim2.new(p,-5,0.5,-5)
                        pcall(callback, val)
                    end,
            ...
            function SectionObj:CreateDropdown(cfg)
                ...
                NewGui("UIStroke",  { Color = Color3.fromRGB(255,255,255), Transparency = 0.96, Thickness = 1, Parent = Header })
                NewGui("TextLabel", {
                ...
                NewGui("UIStroke", { Color = Theme.Border, Transparency = 0.7, Thickness = 1, Parent = DropList })
            ...
            function SectionObj:CreateInput(cfg)
                ...
                local Box = NewGui("TextBox", {
                    ...
                    PlaceholderColor3 = Color3.fromRGB(60,30,30),
                    Text            = "",
                    TextColor3      = Theme.TextPrimary,
                    TextSize        = 12,
                    Font            = Enum.Font.Gotham,
                ...
                Box.FocusLost:Connect(function(enter)
                    Tween(Stroke, TweenInfo.new(0.1), { Color = Color3.fromRGB(42,8,8) })
            ...
            function SectionObj:CreateButton(cfg)
                ...
                NewGui("UIStroke", { Color = Theme.Border, Transparency = 0.6, Thickness = 1, Parent = Btn })

                Btn.MouseButton1Click:Connect(function()
                    Tween(Btn, TweenInfo.new(0.08), {
            ...
            function SectionObj:CreateKeybind(cfg)
                ...
                NewGui("UICorner", { CornerRadius = UDim.new(0,6), Parent = Row })
                NewGui("UIStroke", { Color = Color3.fromRGB(255,255,255), Transparency = 0.96, Thickness = 1, Parent = Row })
                NewGui("TextLabel", {
                ...
                NewGui("UIStroke", { Color = Theme.Border, Transparency = 0.7, Thickness = 1, Parent = KeyBtn })
...
function CriminalHub:Notify(cfg)
    ...
    -- Tenta encontrar ScreenGui existente ou cria novo
    ...
    local Notif = NewGui("Frame", {
        ...
        BackgroundColor3= Color3.fromRGB(9,1,1),
        BorderSizePixel = 0,
        Parent          = gui,
    })
    NewGui("UICorner",  { CornerRadius = UDim.new(0,8), Parent = Notif })
    NewGui("UIStroke",  { Color = Theme.Border, Transparency = 0.5, Thickness = 1, Parent = Notif })
    ...
    Tween(Notif, TweenInfo.new(0.25, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {
        Position = UDim2.new(1,-14,1,-80),
    })

    task.delay(duration, function()
        Tween(Notif, TweenInfo.new(0.2, Enum.EasingStyle.Quart), {
            Position        = UDim2.new(1,10,1,-80),
            BackgroundTransparency = 1,
        })
