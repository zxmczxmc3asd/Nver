...
function RedlineUI:CreateWindow(opts)
	...
	accentDot.Position = UDim2.fromOffset(16, 24)
	...
	accentGlowStroke.Transparency = 0.3
	...
	TitleLabel.Position = UDim2.fromOffset(32, 24)
	...
	if subtitle ~= "" then
		...
		SubtitleLabel.Position = UDim2.fromOffset(32 + TitleLabel.TextBounds.X + 8, 25)
		SubtitleLabel.Size = UDim2.fromOffset(160, 14)
		SubtitleLabel.Parent = TopBar
	end

	-- window controls (minimize / close) - visible colored buttons
	local function makeTopBarButton(iconName, posFromRight, bgColor, hoverColor, iconColor)
		...
		local icon = Icons.Create(iconName, iconColor, 13)
	...
	-- Close button: red-toned
	local closeBtn, closeIcon = makeTopBarButton(
		"x",
		12,
		Color3.fromRGB(60, 20, 22),
		Color3.fromRGB(176, 32, 42),
		Color3.fromRGB(220, 120, 120)
	)
	-- Minimize button: muted
	local minimizeBtn, minimizeIcon = makeTopBarButton(
		"minus",
		46,
		Color3.fromRGB(32, 28, 28),
		Color3.fromRGB(55, 45, 45),
		Color3.fromRGB(180, 160, 160)
	)

	closeBtn.MouseEnter:Connect(function()
		-- icon brightens on hover (handled above)
	end)
