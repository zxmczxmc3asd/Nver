...
function RedlineUI:CreateWindow(opts)
	...
	local function makeTopBarButton(iconName, posFromRight, bgColor, hoverColor, iconColor)
		...
		local icon = Icons.Create(iconName, iconColor, 16)
		icon.AnchorPoint = Vector2.new(0.5, 0.5)
		icon.Position = UDim2.fromScale(0.5, 0.5)
		icon.Parent = btn

		btn.MouseEnter:Connect(function() tween(btn, { BackgroundColor3 = hoverColor }, 0.1) end)
		btn.MouseLeave:Connect(function() tween(btn, { BackgroundColor3 = bgColor }, 0.1) end)
		return btn
	end

	local closeBtn    = makeTopBarButton("x",     12, Color3.fromRGB(55,16,20),  Color3.fromRGB(185,28,40), Color3.fromRGB(225,225,225))
	local minimizeBtn = makeTopBarButton("minus", 48, Color3.fromRGB(28,24,25),  Color3.fromRGB(50,40,42),  Color3.fromRGB(225,225,225))
	----------------------------------------------------------------
	-- BODY
	----------------------------------------------------------------
